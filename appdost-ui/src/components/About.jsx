    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-gray-600 text-center max-w-3xl mx-auto mb-12">
          We specialize in delivering comprehensive IT solutions that empower businesses to thrive in the digital age. From innovative app development to robust cybersecurity measures, we ensure your digital journey is seamless and successful.
        </p>
